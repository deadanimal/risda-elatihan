...
class CreateMatlamatTahunanPerbelanjaansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('matlamat_tahunan_perbelanjaans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('matlamat_tahunan_perbelanjaans');
    }
}
