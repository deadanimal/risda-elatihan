...
class CreateMatlamatTahunanPanggilanPesertasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('matlamat_tahunan_panggilan_pesertas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('matlamat_tahunan_panggilan_pesertas');
    }
}
