...
class CreatePerbelanjaanPengajianLanjutansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('perbelanjaan_pengajian_lanjutans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('perbelanjaan_pengajian_lanjutans');
    }
}
