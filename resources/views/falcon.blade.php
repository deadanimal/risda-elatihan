...
<body>
    ...
    <main class="main" id="top">
        <div class="container-fluid" data-layout="container">
            ...
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl" id="themargin">
                <script>
                        ...
                        <li class="nav-item">
                            <div class="theme-control-toggle fa-icon-wait px-2">
                                <input class="form-check-input ms-0 theme-control-toggle-input"
                                    id="themeControlToggle" type="checkbox" data-theme-control="theme" value="dark" />
                                        ...
                                        <div class="list-group list-group-flush fw-normal fs--1">
                                                ...
                                                <a class="notification notification-flush notification-unread"
                                                    ...
                                                    <div class="notification-body">
                                                        <p class="mb-1"><strong>Albert Brooks</strong>
                                                            reacted to <strong>Mia Khalifa's</strong> status</p>
                                            ...
                                            <div class="list-group-item">
                                                <a class="border-bottom-0 notification notification-flush" href="#!">
                                                    ...
                                                    <div class="notification-body">
                                                        <p class="mb-1"><strong>James Cameron</strong>
                    ...
                    <div class="col-lg-5 col-xl-4 ps-lg-2 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                                    <div class="file-thumbnail"><img class="img-fluid"
                                            src="assets/img/icons/docs.png" alt="" />
                                    </div>
                                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                                        <h6 class="mb-1"><a class="stretched-link text-900 fw-semi-bold"
                    ...
                    <div class="col-sm-6 col-xxl-3 ps-sm-2 order-xxl-1 mb-3 mb-xxl-0">
                        <div class="card h-100">
                            ...
                            <div class="card-body d-flex flex-center flex-column">
                                <div class="progress-circle progress-circle-dashboard"
                                    data-options='{"color":"url(#gradient)","progress":93,"strokeWidth":5,"trailWidth":5}'>
                                </div>
    ...
    {{-- <script>
        ...
        $(window).scroll(function(event) {
            ...
            // }
            if (st > 120) {
                $("#themargin").css('margin-top', 100);
            }
            if (st > 180) {
                $("#themargin").css('margin-top', 0);
            }
            if (st == 0) {
                $("#themargin").css('margin-top', 220);
            }
            lastScrollTop = st;
        });
    </script> --}}
