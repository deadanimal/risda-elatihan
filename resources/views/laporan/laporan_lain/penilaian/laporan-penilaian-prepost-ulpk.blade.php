...
<style>
    ...
    <a id="downloadpdf" style="display: none"
        href="{{ route('pdf_pretest_ulpk', $kursus->id) }}">Download</a>
    <a id="downloadexcel" style="display: none" href="{{ route('excel_pretest_ulpk', $kursus->id) }}" download="Laporan Penilaian Pre Test dan Post Test">Download</a>
    ...
    <div class="card mt-5 ">
        ...
        <div class="card-body">
            @include(
                'laporan.laporan_lain.excel.penilaian.laporan-penilaian-prepost-ulpk')
        </div>
