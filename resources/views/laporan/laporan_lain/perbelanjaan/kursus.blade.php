...
@section('content')
    <div class="container">
        ...
        href="{{ route('pdf-perbelanjaan-kursus') }}">Download</a>

        <a id="downloadexcel" style="display: none" href="{{ route('excel-perbelanjaan-kursus') }}">Download</a>
        ...
        <div class="card mt-5 ">
            ...
            <div class="card-body">
                @include(
                    'laporan.laporan_lain.excel.perbelanjaan.kursus'
                )
