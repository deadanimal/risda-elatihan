...
<head>
    <title>QR Code Penilaian Pre Test</title>
    <meta charset="utf-8">
            ...
            <div class=" container-fluid">
                ...
                <div class="row">
                    <div class="col" style="text-align: center">
                        ...
                        <img src="https://api.qrserver.com/v1/create-qr-code/?data=risda-elatihan.prototype.com.my/penilaian/jawab-pre-post-test" alt="" title="" />

                    </div>
                <div class="b">
                    <div class="col" style="text-align: justify">
                        <h3 style="text-transform:capitalize;text-align:center">PENILAIAN PRE TEST</h3>
