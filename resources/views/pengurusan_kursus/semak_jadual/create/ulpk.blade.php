                ...
                <form action="/pengurusan_kursus/semak_jadual" method="POST" id="form_add">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-7">
                            ...
                            <input type="text" name="kursus_unit_latihan" id="unitlatihan" class="form-select form-control" value="Pekebun Kecil" readonly>
                        </div>
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="kursus_masa_pendaftaran" type="time" placeholder="H:i"
                                    required oninvalid="this.setCustomValidity('Sila pilih masa pendaftaran.')"
                                    oninput="setCustomValidity('')" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row mb-0">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3" id="julat_umur">
                                <label class="col-form-label">JULAT UMUR<span class="text-danger">*</span></label>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <label class="col-form-label">OBJEKTIF<span class="text-danger">*</span></label>
                            <textarea class="form-control" rows="3" name="kursus_objektif" required
                                oninvalid="this.setCustomValidity('Sila nyatakan objektif kursus.')"
                                oninput="setCustomValidity('')"></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                            <label class="col-form-label">SILIBUS<span class="text-danger">*</span></label>
