            ...
            <form action="/pengurusan_kursus/semak_jadual" method="POST" id="form_add">
                ...
                <div class="row mb-2">
                    <div class="col-lg-7">
                        ...
                        <select class="form-select form-control" name="kursus_unit_latihan">
                            <option selected="" hidden value="{{$jadual->kursus_unit_latihan}}">{{$jadual->kursus_unit_latihan}}</option>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control tahun" type="text" name="tahun" id="tahun" value="{{$jadual->tahun}}"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="col-form-label">TARIKH DAFTAR</label>
                            <input class="form-control" type="date" name="kursus_tarikh_daftar" value="{{$jadual->kursus_tarikh_daftar}}"/>
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select class="form-select form-control" name="kursus_bidang" id="kursus_bidang">
                            <option selected="" hidden value="{{$jadual->kursus_bidang}}">Sila Pilih</option>
                            @foreach ($bidang as $b)
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select class="form-select form-control" name="kod_kategori" id="kursus_kategori">
                            <option selected="" hidden value="{{$jadual->kod_kategori}}">Sila Pilih</option>
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select class="form-select form-control" name="kod_kursus" id="tajuk">
                            <option selected="" hidden value="{{$jadual->kod_kursus}}">Sila Pilih</option>
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select class="form-select form-control" name="id_siri" id="siri">
                            <option selected="" hidden value="{{$jadual->id_siri}}">Sila Pilih</option>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="kursus_nama" id="nama_kursus" value="{{$jadual->kursus_nama}}" />
                        </div>
                    </div>
                </div>
                {{-- sini --}}
                <div class="row mb-3">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="kursus_kod_nama_kursus" value="{{$jadual->kursus_kod_nama_kursus}}"/>
                        </div>
                    </div>
                </div>
                <div class="row mb-0">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="date" name="tarikh_mula" id="tm" value="{{$jadual->tarikh_mula}}"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="col-form-label">TARIKH TAMAT KURSUS</label>
                            <input class="form-control" type="date" name="tarikh_tamat" id="tt" value="{{$jadual->tarikh_tamat}}"/>
                        </div>
                    </div>
                </div>
                <div class="row mb-0">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="bilangan_hari" id="tk" value="{{$jadual->bilangan_hari}}"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select form-control" name="kursus_status_pelaksanaan">
                                <option selected="" hidden value="{{$jadual->kursus_status_pelaksanaan}}">Sila Pilih</option>
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control datetimepicker" name="kursus_masa_pendaftaran" id="timepicker1"
                                ...
                                data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}' value="{{$jadual->kursus_masa_pendaftaran}}"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="col-form-label">TARIKH TUTUP TAWARAN</label>
                            <input class="form-control datetimepicker" type="date" name="kursus_tarikh_tutup" value="{{$jadual->kursus_tarikh_tutup}}" />
                        </div>
                    </div>
                </div>
                <div class="row mb-0">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="kursus_hrmis" value="{{$jadual->kursus_hrmis}}"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <div class="row m-0 p-0">
                                <div class="col-lg-4 p-0 m-0">
                                    <input class="form-control" type="text" name="kursus_julat_umur1" value="{{$jadual->kursus_julat_umur1}}"/>
                                </div>
                                <div class="col-lg-4 p-0 m-0 text-center">
                                    <span class="risda-g">HINGGA</span>
                                </div>
                                <div class="col-lg-4 p-0 m-0">
                                    <input class="form-control" type="text" name="kursus_julat_umur2" value="{{$jadual->kursus_julat_umur2}}" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select class="form-select form-control" name="kursus_pengendali_latihan">
                            <option selected="" hidden value="{{$jadual->kursus_pengendali_latihan}}">Sila Pilih</option>
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="kursus_catatan" value="{{$jadual->kursus_catatan}}">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select class="form-select form-control" name="kursus_tempat">
                            <option selected="" hidden value="{{$jadual->kursus_tempat}}">Sila Pilih</option>
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <textarea class="form-control" rows="3" name="kursus_alamat_tempat_kursus">{{$jadual->kursus_alamat_tempat_kursus}}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        <label class="col-form-label">OBJEKTIF</label>
                        <textarea class="form-control" rows="3" name="kursus_objektif">{{$jadual->kursus_objektif}}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        <label class="col-form-label">SILIBUS</label>
                        <input type="text" class="form-control" name="kursus_silibus" value="{{$jadual->kursus_silibus}}">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        <label class="col-form-label">METODOLOGI</label>
                        <input type="text" class="form-control" name="kursus_metodologi" value="{{$jadual->kursus_metodologi}}">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="kursus_no_ft" value="{{$jadual->kursus_no_ft}}">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        <label class="col-form-label">STAF YANG BERTANGGUNGJAWAB</label>
                        <input type="text" class="form-control" name="kursus_staf_yang_bertanggungjawab" value="{{$jadual->kursus_staf_yang_bertanggungjawab}}">
                    </div>
                </div>
