                ...
                <form action="/pengurusan_pengguna/pengguna/pekebun_kecil/semak" method="post">
                    ...
                    <div class="row">
                        <div class="col-8 col-lg-10 mb-lg-3 pe-0 pe-lg-3">
                            ...
                            <input class="form-control" type="text" name="no_KP" id="ori_nric" value="{{$pekebun['No_KP']}}" maxlength="12"/>
                        </div>
                        <div class="col-4 col-lg-2 mb-lg-3 align-self-end text-end ps-0">
                            <button type="submit" class="btn risda-bg-dg text-white"><i class="fas fa-search"></i> Cari</button>
                        </div>
                    </div>
                </form>
                <form action="/pengurusan_pengguna/pengguna" method="post">
                    ...
                    <div class="col-lg-10">
                        <div class="row mt-4">
                            ...
                            <div class="col-6">
                                <div class="d-grid gap-2">
                                    <a href="/pengurusan_pengguna/pengguna/pekebun_kecil" class="btn btn-outline-primary">Batal</a>
                                </div>
                            </div>
                        </div>
                    </div>
