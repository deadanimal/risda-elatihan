    ...
    <div class="container">
        <div class="row mt-3 mb-2">
            <div class="col-12 mb-2">
                ...
                <p class="h5" style="color: rgb(43,93,53); ">KOD QR PUSAT LATIHAN</p>
            </div>
        </div>
                ...
                <table class="table datatable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">KOD QR</th>
                            <th scope="col">CETAK KOD QR</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="qrcode" id="{{ $pl->id }}"></div>
                            </td>
                            <td>
                                <a href="/us-uls/kehadiran/cetak-pl/{{$pl->id}}" class="btn btn-sm btn-primary"><span class="fas fa-print"></span></a>
                            </td>
                        @endforeach
