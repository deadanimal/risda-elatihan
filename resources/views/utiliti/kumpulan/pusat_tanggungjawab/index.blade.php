                            ...
                            <div class="p-4 pb-0">
                                <form action="/utiliti/pusat_tanggungjawab" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="alamat_PT_baris1" />
                                        <input class="form-control" type="text" name="alamat_PT_baris2" />
                                        <input class="form-control" type="text" name="alamat_PT_baris3" />
                                        <input class="form-control" type="text" name="alamat_PT_baris4" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" maxlength="11" name="no_Telefon_PT" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label">NO. FAKS</label>
                                        <input class="form-control" type="text" maxlength="11" name="no_Faks_PT" />
                                    </div>
                                    <div class="mb-3">
                                                ...
                                                <div class="p-4 pb-0">
                                                    <form action="/utiliti/pusat_tanggungjawab/{{ $PT->id }}"
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="col-form-label">NO. TELEFON</label>
                                                            <input class="form-control" type="text"
                                                                name="no_Telefon_PT" value="{{$PT->no_Telefon_PT}}"/>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="col-form-label">NO. FAKS</label>
                                                            <input class="form-control" type="text" name="no_Faks_PT" value="{{$PT->no_Faks_PT}}" />
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="col-form-label">KETERANGAN</label>
