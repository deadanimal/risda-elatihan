                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content position-relative">
                        ...
                        <div class="modal-body p-0">
                            ...
                            <div class="p-4 pb-0">
                                <form action="/utiliti/kursus/bidang_kursus" method="POST">
                                    @csrf
                                    <div class="mb-3">
                    ...
                    <table id="table_negeri" class="table table-striped" style="width:100%">
                        ...
                        <tbody class="bg-white">
                            @foreach ($bidangKursus as $key => $bk)
                                ...
                                <div class="modal fade" id="delete_BK_{{ $bk->id }}" tabindex="-1" role="dialog"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document"
                                        style="max-width: 500px">
                                        <div class="modal-content position-relative">
                                            ...
                                            <div class="modal-body p-0">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button"
                                                        data-bs-dismiss="modal">Batal</button>
                                                    <form method="POST" action="/utiliti/kursus/bidang_kursus/{{ $bk->id }}">
                                                        @method('DELETE')
                                                        @csrf
