                                ...
                                <div class="p-4 pb-0">
                                    <form action="/utiliti/kursus/kategori_kursus" method="POST" id="form1">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" name="kod_Kategori_Kursus"
                                                id="kod_kat" />
                                                    ...
                                                    <div class="p-4 pb-0">
                                                        <form action="/utiliti/kursus/kategori_kursus/{{ $KK->id }}"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                @if (str_contains($check, 'ULS'))
                                                                    <select class="form-select form-control"
                                                                        name="UL_Kategori_Kursus" id="unitlatihan">
                                                                        <option value="Staf" selected hidden>Staf
                                                                        </option>
                                                                    </select>
                                                                @elseif(str_contains($check, 'ULPK'))
                                                                    <select class="form-select form-control"
                                                                        name="UL_Kategori_Kursus" id="unitlatihan">
                                                                        <option value="Pekebun Kecil" selected hidden>
                                                                            Pekebun Kecil</option>
                                                                    </select>
                                                                @else
                                                                    <select class="form-select form-control"
                                                                        name="UL_Kategori_Kursus" id="unitlatihan_{{$KK->id}}" onchange="unitlatihan({{$KK->id}})">
                                                                        <option selected="" hidden
                                                                            value="{{ $KK->UL_Kategori_Kursus }}">
                                                                            {{ $KK->UL_Kategori_Kursus }}</option>
                                                                        <option value="Staf">Staf</option>
                                                                        <option value="Pekebun Kecil">Pekebun Kecil
                                                                        </option>
                                                                    </select>
                                                                @endif
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                @if (str_contains($check, 'ULS'))
                                                                    <select class="form-select form-control"
                                                                        name="U_Bidang_Kursus" id="kod_bidang">
                                                                        <option selected="" hidden
                                                                            value="{{ $KK->bidang->U_Bidang_Kursus }}">
                                                                            {{ $KK->bidang->nama_Bidang_Kursus }}
                                                                        </option>
                                                                        @foreach ($bidangKursus as $BK)
                                                                            <option value="{{ $BK->id }}">
                                                                                {{ $BK->nama_Bidang_Kursus }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                @elseif(str_contains($check, 'ULPK'))
                                                                ...
                                                                @else
                                                                    <select class="form-select form-control bidang"
                                                                        name="U_Bidang_Kursus" id="bidang_{{$KK->id}}">
                                                                        <option selected hidden
                                                                            value="{{ $KK->bidang->U_Bidang_Kursus }}">
                                                                            {{ $KK->bidang->nama_Bidang_Kursus }}
                                                                        </option>
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="col-form-label">JENIS LATIHAN</label>
                                                                <select class="form-select form-control" name="jenis_Kategori_Kursus"
                                                                    id="jenis_kategori">
                                                                    <option selected=""
        ...
        <script>
            ...
            function unitlatihan(el) {
                ...
                $('#form1 select[name=U_Bidang_Kursus]').append(
                    `<option selected value='' hidden>Sila Pilih</option>`);
                bid.forEach(element => {
                    if (check == element.UL_Bidang_Kursus) {
                        $('#bidang_'+el).append(
                            `<option value=${element.id} class=${element.kod_Bidang_Kursus}>${element.nama_Bidang_Kursus}</option>`
                        );
                    }
