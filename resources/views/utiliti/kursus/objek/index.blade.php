                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content position-relative">
                        ...
                        <div class="modal-body p-0">
                            ...
                            <div class="p-4 pb-0">
                                <form action="/utiliti/kod_objek" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document"
                                        ...
                                        <div class="modal-content position-relative">
                                            ...
                                            <div class="modal-body p-0">
                                                ...
                                                <div class="p-4 pb-0">
                                                    <form action="/utiliti/kod_objek/{{ $ob->id }}" method="POST">
                                                        @method('PUT')
                                                        @csrf
                                                        <div class="mb-3">
                                                            <label class="col-form-label">KOD OBJEK</label>
                                                            <input class="form-control" type="number" name="kod_Objek"
                                                                value="{{ $ob->kod_Objek }}" readonly />
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="col-form-label">OBJEK</label>
                                                            <input class="form-control" type="text" name="nama_Objek"
                                        ...
                                        <div class="modal-content position-relative">
                                            ...
                                            <div class="modal-body p-0">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button"
                                                        data-bs-dismiss="modal">Batal</button>
                                                    <form method="POST" action="/utiliti/kod_objek/{{ $ob->id }}">
                                                        @method('DELETE')
                                                        @csrf
