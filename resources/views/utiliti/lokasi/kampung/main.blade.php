                        ...
                        <table class="table table-striped datatable" style="width:100%">
                            ...
                            <tbody class="bg-white" id="t_normal">
                                @foreach ($kampung as $key => $k)
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 500px">
                                            <div class="modal-content position-relative">
                                                ...
                                                <div class="modal-body p-0">
                                                    ...
                                                    <div class="p-4 pb-0">
                                                        <form action="/utiliti/lokasi/kampung/{{ $k->id }}"
                                                            method="POST">
                                                            @method('PUT')
                                                            @csrf
                                                            <div class="mb-3">
                                                                <label class="col-form-label">NEGERI</label>
                                                                <select class="form-select" name="U_Negeri_ID" id="{{$k->id}}" onchange="negeri(this)">
                                                                    <option selected="" value="{{ $k->U_Negeri_ID }}" hidden>
                                                                        {{ $k->negeri->Negeri }}</option>
                                                                    @foreach ($negeri as $n)
                                                                        @if ($n->status_negeri == '1')
                                                                            <option value="{{ $n->U_Negeri_ID }}">
                                                                                {{ $n->Negeri }}</option>
                                                                        @endif
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="col-form-label">DAERAH</label>
                                                                <select class="form-select" name="U_Daerah_ID" id="daerah_{{$k->id}}" onchange="daerah(this)" nil="{{$k->id}}">
                                                                    <option selected value="{{ $k->U_Daerah_ID }}" hidden>
                                                                        {{ $k->daerah->Daerah }}</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="col-form-label">MUKIM</label>
                                                                <select class="form-select" name="U_Mukim_ID" id="mukim_{{$k->id}}">
                                                                    <option selected value="{{ $k->U_Mukim_ID }}" hidden>
                                                                        {{ $k->mukim->Mukim }}</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="col-form-label">KOD KAMPUNG</label>
                                                                <input class="form-control" type="text" name="U_Kampung_ID"
                                                                    value="{{ $k->U_Kampung_ID }}"
                                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="col-form-label">KAMPUNG</label>
                                    ...
                                    <div class="modal fade" id="delete_kampung_{{ $k->id }}" tabindex="-1" role="dialog"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 500px">
                                            <div class="modal-content position-relative">
                                                <div class="position-absolute top-0 end-0 mt-2 me-2 z-index-1">
                                                ...
                                                <div class="modal-body p-0">
                                                    ...
                                                    <div class="p-4 pb-0">
                                                        <form action="/utiliti/lokasi/kampung/${ e.id }"
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="col-form-label">NEGERI</label>
                                                                <select class="form-select" name="U_Negeri_ID" id="${ e.id }" onchange="negeri(this)">
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="col-form-label">DAERAH</label>
                                                                <select class="form-select" name="U_Daerah_ID" id="daerah_${ e.id }" onchange="daerah(this)" nil="${ e.id }">
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="col-form-label">MUKIM</label>
                                                                <select class="form-select" name="U_Mukim_ID" id="mukim_${ e.id }">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="form-check form-switch">
                                                                    `
                                                                    + (e.status_kampung == '1' ? '<span class="badge badge-soft-success">Aktif</span>' : '<span class="badge badge-soft-danger">Tidak Aktif</span>') +
                                                                    `
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
