        ...
        <div class="row mb-4">
            <div class="col-12">
                <p class="h4 fw-bold mt-3">
                    MATLAMAT BILANGAN PERBELANJAAN MENGIKUT TAJUK KURSUS
                </p>
            </div>
        </div>
                                        ...
                                        @foreach ($kategori_h[$b->id] as $k)
                                            <tr class="bg-soft-success">
                                                ...
                                                @if ($k->matlamat_perbelanjaan == null)
                                                    ...
                                                    <td>0</td>
                                                @else
                                                    <td>{{ $k->matlamat_perbelanjaan->nama }}</td>
                                                    <td>{{ $k->matlamat_perbelanjaan->jan }}</td>
                                                    <td>{{ $k->matlamat_perbelanjaan->feb }}</td>
                                                    <td>{{ $k->matlamat_perbelanjaan->mac }}</td>
                                                    <td>{{ $k->matlamat_perbelanjaan->apr }}</td>
                                                    <td>{{ $k->matlamat_perbelanjaan->mei }}</td>
                                                    <td>{{ $k->matlamat_perbelanjaan->jun }}</td>
                                                    <td>{{ $k->matlamat_perbelanjaan->jul }}</td>
                                                    <td>{{ $k->matlamat_perbelanjaan->ogos }}</td>
                                                    <td>{{ $k->matlamat_perbelanjaan->sept }}</td>
