        ...
        <div class="row mb-4">
            <div class="col-12">
                <p class="h4 fw-bold mt-3">
                    MATLAMAT BILANGAN PESERTA MENGIKUT TAJUK KURSUS
                </p>
            </div>
        </div>
                                        ...
                                        @foreach ($kategori_h[$b->id] as $k)
                                            ...
                                            <tr class="bg-soft-success">
                                                ...
                                                @if ($k->matlamat_peserta == null)
                                                    ...
                                                    <td>0</td>
                                                @else
                                                    <td>{{ $k->matlamat_peserta->nama }}</td>
                                                    <td>{{ $k->matlamat_peserta->jan }}</td>
                                                    <td>{{ $k->matlamat_peserta->feb }}</td>
                                                    <td>{{ $k->matlamat_peserta->mac }}</td>
                                                    <td>{{ $k->matlamat_peserta->apr }}</td>
                                                    <td>{{ $k->matlamat_peserta->mei }}</td>
                                                    <td>{{ $k->matlamat_peserta->jun }}</td>
                                                    <td>{{ $k->matlamat_peserta->jul }}</td>
                                                    <td>{{ $k->matlamat_peserta->ogos }}</td>
                                                    <td>{{ $k->matlamat_peserta->sept }}</td>
